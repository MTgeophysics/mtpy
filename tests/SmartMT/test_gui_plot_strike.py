...
class TestGUIPlotPhaseTensorPseudoSection(SmartMTGUITestCase):
    def test_plot_type_1(self):
        ...
        _click_area(
            plot_gui._plot_control_ui.ui.radioButton_type_1, pos=self._pos_check_box
        )
        _click_area(
            plot_gui._plot_control_ui.ui.checkBox_plot_tipper, pos=self._pos_check_box
        )
    ...
    def test_plot_type_2(self):
        ...
        # type 2
        _click_area(
            plot_gui._plot_control_ui.ui.radioButton_type_2, pos=self._pos_check_box
        )
        _click_area(
            plot_gui._plot_control_ui.ui.checkBox_plot_tipper, pos=self._pos_check_box
        )
