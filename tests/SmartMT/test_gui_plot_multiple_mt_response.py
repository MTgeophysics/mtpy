...
class TestGUIPlotMultipleMTResponse(SmartMTGUITestCase):
    def test_multiple_mt_response_compare_type_1(self):
        plot_config = self._switch_to_plot(
            MultipleMTResponses, 2
        )  # type: MultipleMTResponses
        _click_area(
            plot_config._plot_control_ui.ui.radioButton_1, pos=self._pos_check_box
        )
        _click_area(
            plot_config._plot_control_ui.ui.checkBox_skew, pos=self._pos_check_box
        )
        _click_area(
            plot_config._plot_control_ui.ui.checkBox_pt, pos=self._pos_check_box
        )
        _click_area(
            plot_config._plot_control_ui.ui.checkBox_strike_i, pos=self._pos_check_box
        )
        _click_area(
            plot_config._plot_control_ui.ui.checkBox_strike_p, pos=self._pos_check_box
        )
        _click_area(
            plot_config._plot_control_ui.ui.checkBox_strike_t, pos=self._pos_check_box
        )
        _click_area(plot_config._arrow_ui.ui.checkBox_real, pos=self._pos_check_box)
        _click_area(
            plot_config._arrow_ui.ui.checkBox_imaginary, pos=self._pos_check_box
        )
    ...
    def test_multiple_mt_response_compare_type_2(self):
        ...
        _click_area(
            plot_config._plot_control_ui.ui.radioButton_2, pos=self._pos_check_box
        )
        _click_area(
            plot_config._plot_control_ui.ui.checkBox_skew, pos=self._pos_check_box
        )
    ...
    def test_multiple_mt_response_compare_type_3(self):
        ...
        _click_area(
            plot_config._plot_control_ui.ui.radioButton_3, pos=self._pos_check_box
        )
        _click_area(
            plot_config._plot_control_ui.ui.checkBox_skew, pos=self._pos_check_box
        )
