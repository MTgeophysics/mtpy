...
class TestModEM_Model(TestCase):
    ...
    def test_make_z_mesh_new(self):
        ...
        expected_air_layers = [10., 10., 10., 20., 20., 20., 30., 30., 40., 50.]
        self.assertTrue(np.all(z_nodes[:n_airlayers] == expected_air_layers))
        expected_air_layers = [0., 10., 20., 30., 50., 70., 90., 120., 150., 190., 240.]
        self.assertTrue(np.all(z_grid[:n_airlayers + 1] == expected_air_layers))

        # check core model part
        testnodes10_5000_16 = [60., 70., 80., 100., 100., 100., 200., 200., 200., 300., 300., 400.,
                               500., 600., 700., 800.]
        testgrid10_5000_16 = [240., 300., 370., 450., 550., 650., 750., 950., 1150., 1350., 1650.,
                              1950., 2350., 2850., 3450., 4150., 4950.]
