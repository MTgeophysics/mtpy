...
class TestResidual(TestCase):
    ...
    def test_read_residual(self):
        ...
        expected_residual_z = np.array([[[-1.02604300 -1.02169400e+00j,  0.57546600 -2.86067700e+01j],
        ...
        expected_residual_tip = np.array([[[  1.99677300e-02 +7.51403000e-03j,
        ...
        expected_perlist= np.array([  1.00000000e-02,   2.05353000e-02,   4.21697000e-02,
                 8.65964000e-02,   1.77828000e-01,   3.65174000e-01,
                 7.49894000e-01,   1.53993000e+00,   3.16228000e+00,
                 6.49382000e+00,   1.33352000e+01,   2.73842000e+01,
                 5.62341000e+01,   1.15478000e+02,   2.37137000e+02,
                 4.86968000e+02,   1.00000000e+03])
    ...
    def test_get_rms(self):
        ...
        expected_rms_by_period = np.array([ 5.0808857 ,  3.47096626,  2.34709635,  1.52675356,  1.09765601,
        ...
        expected_rms_by_period_z = np.array([ 6.21674098,  4.24399835,  2.86799775,  1.86322907,  1.33659998,
        ...
        expected_rms_by_period_tip = np.array([ 0.38789413,  0.3460871 ,  0.27524824,  0.22289946,  0.20383115,
