...
##                       period_list=[1000],
#                       ellipse_size=40,
#                resp_fn=op.join(modeldir,'ModEM_pred.dat'), 
##                model_fn=op.join(modeldir,'ModEM_Model_forward.ws')
#                )
read_data = True
...
if plotdir == 'z':
    ...
    for ss in range(len(doo.station_locations)):
        plt.plot(doo.station_locations['rel_east'][ss],doo.station_locations['rel_north'][ss],'k.')
