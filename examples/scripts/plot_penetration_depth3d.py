...
pen3d.plot_latlon_depth_profile(
    edidir, 95.33, savefig=True, savepath=savepath, fig_dpi=400
)
pen3d.plot_latlon_depth_profile(
    edidir, 48.9956, savefig=True, savepath=savepath, fig_dpi=400
)
pen3d.plot_latlon_depth_profile(
    edidir, 10.839, savefig=True, savepath=savepath, fig_dpi=400
)
