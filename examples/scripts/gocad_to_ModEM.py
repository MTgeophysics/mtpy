...
# create data file
dObj = Data(epsg=epsg)
dObj._initialise_empty_data_array(
    xy, period_list, location_type="LL", station_names=station_names
)
...
cov = Covariance(
    save_path=workdir, smoothing_east=0.3, smoothing_north=0.3, smoothing_z=0.3
)
