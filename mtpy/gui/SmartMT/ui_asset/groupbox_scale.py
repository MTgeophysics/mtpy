...
# Form implementation generated from reading ui file 'groupbox_scale.ui'
#
...
class Ui_GroupBox_Scale(object):
    def setupUi(self, GroupBox_Scale):
        ...
        self.label_time = QtGui.QLabel(GroupBox_Scale)
        self.label_time.setObjectName(_fromUtf8("label_time"))
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.label_time)
        ...
        self.label_map = QtGui.QLabel(GroupBox_Scale)
        self.label_map.setObjectName(_fromUtf8("label_map"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.label_map)
    ...
    def retranslateUi(self, GroupBox_Scale):
        ...
        self.label_time.setToolTip(_translate("GroupBox_Scale", "<html><head/><body><p><span style=\" font-weight:600;\">Period:</span> plot vertical scale in period</p><p><span style=\" font-weight:600;\">Frequency:</span> plot vertical scale in frequency</p></body></html>", None))
        self.label_time.setText(_translate("GroupBox_Scale", "Time Scale", None))
        ...
        self.label_map.setToolTip(_translate("GroupBox_Scale", "<html><head/><body><p>Scale of the map coordinates.</p></body></html>", None))
        self.label_map.setText(_translate("GroupBox_Scale", "Map Scale", None))
