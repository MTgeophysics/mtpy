...
class Ui_Wizard_esport_modem(object):
    def setupUi(self, Wizard_esport_modem):
        ...
        self.gridLayout_8.addItem(spacerItem, 0, 5, 1, 1)
        self.radioButton_select_period = QtGui.QRadioButton(self.wizardPage_period)
        self.radioButton_select_period.setObjectName(_fromUtf8("radioButton_select_period"))
        self.gridLayout_8.addWidget(self.radioButton_select_period, 1, 0, 1, 6)
        self.radioButton_select_by_file = QtGui.QRadioButton(self.wizardPage_period)
        self.radioButton_select_by_file.setObjectName(_fromUtf8("radioButton_select_by_file"))
        self.gridLayout_8.addWidget(self.radioButton_select_by_file, 2, 0, 1, 6)
        self.spinBox = QtGui.QSpinBox(self.wizardPage_period)
        self.spinBox.setObjectName(_fromUtf8("spinBox"))
        self.gridLayout_8.addWidget(self.spinBox, 3, 1, 1, 1)
        self.radioButton_select_by_decade = QtGui.QRadioButton(self.wizardPage_period)
        self.radioButton_select_by_decade.setObjectName(_fromUtf8("radioButton_select_by_decade"))
        self.gridLayout_8.addWidget(self.radioButton_select_by_decade, 3, 0, 1, 1)
        ...
        self.doubleSpinBox_select_period_percent = QtGui.QDoubleSpinBox(self.wizardPage_period)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_select_period_percent.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_select_period_percent.setSizePolicy(sizePolicy)
        self.doubleSpinBox_select_period_percent.setMaximum(100.0)
        self.doubleSpinBox_select_period_percent.setProperty("value", 10.0)
        self.doubleSpinBox_select_period_percent.setObjectName(_fromUtf8("doubleSpinBox_select_period_percent"))
        self.gridLayout_8.addWidget(self.doubleSpinBox_select_period_percent, 0, 3, 1, 1)
        self.radioButton_select_period_percent = QtGui.QRadioButton(self.wizardPage_period)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.radioButton_select_period_percent.sizePolicy().hasHeightForWidth())
        self.radioButton_select_period_percent.setSizePolicy(sizePolicy)
        self.radioButton_select_period_percent.setChecked(True)
        self.radioButton_select_period_percent.setObjectName(_fromUtf8("radioButton_select_period_percent"))
        self.gridLayout_8.addWidget(self.radioButton_select_period_percent, 0, 0, 1, 3)
        self.label_27 = QtGui.QLabel(self.wizardPage_period)
        self.label_27.setObjectName(_fromUtf8("label_27"))
        self.gridLayout_8.addWidget(self.label_27, 3, 2, 1, 4)
        ...
        self.groupBox_sign_impedance.setFlat(True)
        self.groupBox_sign_impedance.setObjectName(_fromUtf8("groupBox_sign_impedance"))
        self.horizontalLayout_sign_impedance = QtGui.QHBoxLayout(self.groupBox_sign_impedance)
        self.horizontalLayout_sign_impedance.setObjectName(_fromUtf8("horizontalLayout_sign_impedance"))
        ...
        self.horizontalLayout_sign_impedance.addLayout(self.verticalLayout_4)
        ...
        self.groupBox_sign_vertical.setFlat(True)
        self.groupBox_sign_vertical.setObjectName(_fromUtf8("groupBox_sign_vertical"))
        self.horizontalLayout_sign_vertical = QtGui.QHBoxLayout(self.groupBox_sign_vertical)
        self.horizontalLayout_sign_vertical.setObjectName(_fromUtf8("horizontalLayout_sign_vertical"))
        ...
        self.horizontalLayout_sign_vertical.addLayout(self.verticalLayout_5)
        ...
        self.label_component_error_types = QtGui.QLabel(self.wizardPage_error_type)
        self.label_component_error_types.setWordWrap(True)
        self.label_component_error_types.setObjectName(_fromUtf8("label_component_error_types"))
        self.gridLayout_3.addWidget(self.label_component_error_types, 9, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.label_error_tipper, 1, 0, 1, 1)
        self.checkBox_component_error_types = QtGui.QCheckBox(self.wizardPage_error_type)
        self.checkBox_component_error_types.setObjectName(_fromUtf8("checkBox_component_error_types"))
        self.gridLayout_3.addWidget(self.checkBox_component_error_types, 8, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.label_error_floor, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_error_value, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_error_egbert, 3, 0, 1, 1)
        self.doubleSpinBox_error_egbert = QtGui.QDoubleSpinBox(self.wizardPage_error_type)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_error_egbert.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_error_egbert.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_error_egbert, 3, 1, 1, 1)
        self.doubleSpinBox_error_floor = QtGui.QDoubleSpinBox(self.wizardPage_error_type)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_error_floor.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_error_floor.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_error_floor, 4, 1, 1, 1)
        self.doubleSpinBox_error_tipper = QtGui.QDoubleSpinBox(self.wizardPage_error_type)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_error_tipper.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_error_tipper.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_error_type.sizePolicy().hasHeightForWidth())
        self.comboBox_error_type.setSizePolicy(sizePolicy)
        ...
        self.comboBox_error_type.addItem(_fromUtf8(""))
        self.comboBox_error_type.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.comboBox_error_type, 2, 1, 1, 1)
        self.doubleSpinBox_error_value = QtGui.QDoubleSpinBox(self.wizardPage_error_type)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_error_value.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_error_value.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_error_value, 6, 1, 1, 1)
        self.groupBox_component_error_types = QtGui.QGroupBox(self.wizardPage_error_type)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_component_error_types.sizePolicy().hasHeightForWidth())
        self.groupBox_component_error_types.setSizePolicy(sizePolicy)
        self.groupBox_component_error_types.setCheckable(False)
        self.groupBox_component_error_types.setChecked(False)
        self.groupBox_component_error_types.setObjectName(_fromUtf8("groupBox_component_error_types"))
        self.gridLayout_2 = QtGui.QGridLayout(self.groupBox_component_error_types)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.checkBox_zxx = QtGui.QCheckBox(self.groupBox_component_error_types)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.checkBox_zxy = QtGui.QCheckBox(self.groupBox_component_error_types)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBox_error_type_zxx = QtGui.QComboBox(self.groupBox_component_error_types)
        ...
        self.comboBox_error_type_zxy = QtGui.QComboBox(self.groupBox_component_error_types)
        ...
        self.comboBox_error_type_zyx = QtGui.QComboBox(self.groupBox_component_error_types)
        ...
        self.comboBox_error_type_zyy = QtGui.QComboBox(self.groupBox_component_error_types)
        ...
        self.checkBox_zyx = QtGui.QCheckBox(self.groupBox_component_error_types)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.checkBox_zyy = QtGui.QCheckBox(self.groupBox_component_error_types)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.groupBox_component_error_types, 10, 0, 1, 2)
        self.verticalLayout_error_types = QtGui.QVBoxLayout()
        self.verticalLayout_error_types.setObjectName(_fromUtf8("verticalLayout_error_types"))
        self.gridLayout_3.addLayout(self.verticalLayout_error_types, 7, 0, 1, 2)
        ...
        self.pushButton_test = QtGui.QPushButton(self.wizardPage_output)
        self.pushButton_test.setObjectName(_fromUtf8("pushButton_test"))
        self.gridLayout_5.addWidget(self.pushButton_test, 4, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.pushButton_browse, 1, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.lineEdit_full_output, 3, 0, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.comboBox_directory, 1, 1, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.comboBox_output_name, 0, 1, 1, 3)
        self.checkBox_open_output_dir = QtGui.QCheckBox(self.wizardPage_output)
        self.checkBox_open_output_dir.setChecked(True)
        self.checkBox_open_output_dir.setObjectName(_fromUtf8("checkBox_open_output_dir"))
        self.gridLayout_5.addWidget(self.checkBox_open_output_dir, 4, 2, 1, 2)
        ...
        self.label_18.setBuddy(self.lineEdit_resistivity_air)
        self.label_19.setBuddy(self.lineEdit_resistivity_sea)
        ...
        Wizard_esport_modem.setTabOrder(self.radioButton_impedance_full, self.radioButton_impedance_off_diagonal)
        Wizard_esport_modem.setTabOrder(self.radioButton_impedance_off_diagonal, self.radioButton_impedance_none)
        Wizard_esport_modem.setTabOrder(self.radioButton_impedance_none, self.radioButton_vertical_full)
        Wizard_esport_modem.setTabOrder(self.radioButton_vertical_full, self.radioButton_vertical_none)
        Wizard_esport_modem.setTabOrder(self.radioButton_vertical_none, self.radioButton_unit_vmt)
        Wizard_esport_modem.setTabOrder(self.radioButton_unit_vmt, self.radioButton_unit_mvkmnt)
        Wizard_esport_modem.setTabOrder(self.radioButton_unit_mvkmnt, self.radioButton_unit_ohm)
        Wizard_esport_modem.setTabOrder(self.radioButton_unit_ohm, self.comboBox_error_type)
        ...
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_error_floor, self.doubleSpinBox_error_value)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_error_value, self.checkBox_zxx)
        ...
        Wizard_esport_modem.setTabOrder(self.comboBox_error_type_zyy, self.radioButton_format_1)
        Wizard_esport_modem.setTabOrder(self.radioButton_format_1, self.radioButton_format_2)
        Wizard_esport_modem.setTabOrder(self.radioButton_format_2, self.comboBox_epsg)
        Wizard_esport_modem.setTabOrder(self.comboBox_epsg, self.doubleSpinBox_cell_size_east)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_cell_size_east, self.doubleSpinBox_cell_szie_north)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_cell_szie_north, self.spinBox_num_layers)
        Wizard_esport_modem.setTabOrder(self.spinBox_num_layers, self.spinBox_num_air_layers)
        Wizard_esport_modem.setTabOrder(self.spinBox_num_air_layers, self.doubleSpinBox_z1_thickness)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_z1_thickness, self.doubleSpinBox_target_depth)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_target_depth, self.doubleSpinBox_bottom)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_bottom, self.spinBox_pad_east)
        Wizard_esport_modem.setTabOrder(self.spinBox_pad_east, self.spinBox_pad_north)
        Wizard_esport_modem.setTabOrder(self.spinBox_pad_north, self.spinBox_pad_z)
        Wizard_esport_modem.setTabOrder(self.spinBox_pad_z, self.doubleSpinBox_pad_stretch_h)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_pad_stretch_h, self.doubleSpinBox_pad_stretch_v)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_pad_stretch_v, self.comboBox_topography_file)
        Wizard_esport_modem.setTabOrder(self.comboBox_topography_file, self.pushButton_browse_topography_file)
        Wizard_esport_modem.setTabOrder(self.pushButton_browse_topography_file, self.radioButton_interpo_method_nearest)
        Wizard_esport_modem.setTabOrder(self.radioButton_interpo_method_nearest, self.radioButton_interpo_method_linear)
        Wizard_esport_modem.setTabOrder(self.radioButton_interpo_method_linear, self.radioButton_interpo_method_cubic)
        Wizard_esport_modem.setTabOrder(self.radioButton_interpo_method_cubic, self.lineEdit_resistivity_air)
        Wizard_esport_modem.setTabOrder(self.lineEdit_resistivity_air, self.lineEdit_resistivity_sea)
        Wizard_esport_modem.setTabOrder(self.lineEdit_resistivity_sea, self.doubleSpinBox_smoothing_east)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_smoothing_east, self.doubleSpinBox_smoothing_north)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_smoothing_north, self.doubleSpinBox_smoothing_z)
        Wizard_esport_modem.setTabOrder(self.doubleSpinBox_smoothing_z, self.spinBox_smoothing_number)
        Wizard_esport_modem.setTabOrder(self.spinBox_smoothing_number, self.comboBox_output_name)
        ...
        Wizard_esport_modem.setTabOrder(self.pushButton_browse, self.lineEdit_full_output)
        Wizard_esport_modem.setTabOrder(self.lineEdit_full_output, self.pushButton_test)
    ...
    def retranslateUi(self, Wizard_esport_modem):
        ...
        self.label_25.setText(_translate("Wizard_esport_modem", "The following .edi files will be included in the ModEM data", None))
        ...
        self.radioButton_select_period.setText(_translate("Wizard_esport_modem", "Select periods manually (by individual and/or intervals).", None))
        self.radioButton_select_by_file.setText(_translate("Wizard_esport_modem", "Select periods by periods presented in an .edi file.", None))
        self.radioButton_select_by_decade.setText(_translate("Wizard_esport_modem", "Select ", None))
        self.label_26.setText(_translate("Wizard_esport_modem", "of edi files.", None))
        self.doubleSpinBox_select_period_percent.setSuffix(_translate("Wizard_esport_modem", "%", None))
        self.radioButton_select_period_percent.setText(_translate("Wizard_esport_modem", "Select periods that are present in at least", None))
        self.label_27.setText(_translate("Wizard_esport_modem", "periods per decade.", None))
...
"                         ", None))
        ...
        self.label_error_tipper.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Absolute tipper error, all tipper error will be\n"
"                       set to\n"
...
"                   ", None))
        ...
        self.label_error_floor.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Percentage to set the error floor at, anything\n"
"                       below\n"
...
"                   ", None))
        ...
        self.label_error_value.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Percentage to multiply Z by, to set error.\n"
"                       Default is 5\n"
"                       for 5% of Z as error.</p></body></html>\n"
"                   ", None))
        self.label_error_value.setText(_translate("Wizard_esport_modem", "Value Error Level", None))
        self.label_error_egbert.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Percentage to multiply sqrt(zxy*zyx) by.\n"
...
"                   ", None))
        ...
        self.doubleSpinBox_error_egbert.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Percentage to multiply sqrt(zxy*zyx) by.\n"
"                       Default is 3 precent as prescribed by Egbert &amp; Kelbert.</p></body></html>\n"
"                   ", None))
        self.doubleSpinBox_error_egbert.setSuffix(_translate("Wizard_esport_modem", "%", None))
        self.doubleSpinBox_error_floor.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Percentage to set the error floor at, anything\n"
...
"                   ", None))
        ...
        self.doubleSpinBox_error_tipper.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Absolute tipper error, all tipper error will be\n"
...
"                   ", None))
        ...
        self.doubleSpinBox_error_value.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Percentage to multiply Z by, to set error.\n"
"                       Default is 5\n"
"                       for 5% of Z as error.</p></body></html>\n"
"                   ", None))
        ...
        self.radioButton_format_2.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>This option is currently disabled due to its\n"
...
"                                     ", None))
        ...
        self.label_bottom.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>absolute bottom of the model</p></body></html>", None))
...
"                                 ", None))
        ...
        self.radioButton_interpo_method_nearest.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Use the value at the data point closest to the\n"
...
"                  ", None))
        ...
        self.radioButton_interpo_method_linear.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Tesselate the input point set to n-dimensional\n"
...
"                  ", None))
        ...
        self.radioButton_interpo_method_cubic.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>use the value determined from a cubic spline.</p></body></html>", None))
        ...
        self.label_24.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Halfspace resistivity value for initial\n"
"                            reference model</p></body></html>\n"
"                        ", None))
        self.label_24.setText(_translate("Wizard_esport_modem", "Initial Cell Resistivity", None))
        self.lineEdit_resistivity_init.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Halfspace resistivity value for initial\n"
"                            reference model</p></body></html>\n"
"                        ", None))
        ...
        self.label_20.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Smoothing in the X direction.</p></body></html>", None))
        self.label_20.setText(_translate("Wizard_esport_modem", "East", None))
        self.doubleSpinBox_smoothing_east.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Smoothing in the X direction.</p></body></html>", None))
        self.label_21.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Smoothing in the Y direction.</p></body></html>", None))
        self.label_21.setText(_translate("Wizard_esport_modem", "North", None))
        self.doubleSpinBox_smoothing_north.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Smoothing in the Y direction.</p></body></html>", None))
        self.label_22.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Vertical smoothing</p></body></html>", None))
        self.label_22.setText(_translate("Wizard_esport_modem", "Z", None))
        self.doubleSpinBox_smoothing_z.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Vertical smoothing</p></body></html>", None))
        self.label_23.setToolTip(_translate("Wizard_esport_modem", "<html><head/><body><p>Number of times the smoothing should be applied\n"
...
"                      (1 interger &gt;= 0)</p></body></html>\n"
"                  ", None))
        self.label_14.setText(_translate("Wizard_esport_modem", "<html><head/><body><p>Please select a ETOPO1 .asc file, which can be\n"
