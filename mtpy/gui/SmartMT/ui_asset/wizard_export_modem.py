...
class Ui_Wizard_esport_modem(object):
    def setupUi(self, Wizard_esport_modem):
        ...
        self.label_25 = QtGui.QLabel(self.wizardPage_error_type)
        ...
        Wizard_esport_modem.setTabOrder(self.radioButton_vertical_none, self.radioButton_impedance_sign_plus)
        Wizard_esport_modem.setTabOrder(self.radioButton_impedance_sign_plus, self.radioButton_impedance_sign_minus)
        Wizard_esport_modem.setTabOrder(self.radioButton_impedance_sign_minus, self.radioButton_vertical_sign_plus)
        Wizard_esport_modem.setTabOrder(self.radioButton_vertical_sign_plus, self.radioButton_vertical_sign_minus)
        Wizard_esport_modem.setTabOrder(self.radioButton_vertical_sign_minus, self.radioButton_unit_vmt)
...
"          ", None))
        self.label_error_value.setText(_translate("Wizard_esport_modem", "Value Error", None))
...
"          ", None))
        self.label_error_tipper.setText(_translate("Wizard_esport_modem", "Tipper Error", None))
...
"          ", None))
        self.label_error_floor.setText(_translate("Wizard_esport_modem", "Floor Error", None))
...
"                   ", None))
        self.label_error_egbert.setText(_translate("Wizard_esport_modem", "Egbert Error", None))
...
"          ", None))
        ...
        self.label_25.setText(_translate("Wizard_esport_modem", "TextLabel", None))
