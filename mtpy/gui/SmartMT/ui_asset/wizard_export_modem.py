...
"          ", None))
        ...
        self.label_component_error_types.setText(_translate("Wizard_esport_modem", "Configure error types for each individual component by checking the box then select a error\n"
