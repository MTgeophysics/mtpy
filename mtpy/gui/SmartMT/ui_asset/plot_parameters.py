...
class Ui_GroupBoxParameters(object):
    def setupUi(self, GroupBoxParameters):
        ...
        GroupBoxParameters.resize(340, 401)
        ...
        self.page_plot_parameters.setGeometry(QtCore.QRect(0, 0, 338, 332))
        ...
        self.page_common_settings.setGeometry(QtCore.QRect(0, 0, 338, 323))
        ...
        GroupBoxParameters.setTabOrder(self.groupBox_title, self.lineEdit_title)
        GroupBoxParameters.setTabOrder(self.lineEdit_title, self.spinBox_fontsize)
        GroupBoxParameters.setTabOrder(self.spinBox_fontsize, self.horizontalSlider_x)
        GroupBoxParameters.setTabOrder(self.horizontalSlider_x, self.doubleSpinBox_x)
        GroupBoxParameters.setTabOrder(self.doubleSpinBox_x, self.horizontalSlider_y)
        GroupBoxParameters.setTabOrder(self.horizontalSlider_y, self.doubleSpinBox_y)
        GroupBoxParameters.setTabOrder(self.doubleSpinBox_y, self.comboBox_horizontal_alignment)
        GroupBoxParameters.setTabOrder(self.comboBox_horizontal_alignment, self.comboBox_vertical_alignment)
        GroupBoxParameters.setTabOrder(self.comboBox_vertical_alignment, self.groupBox_figure_size)
        GroupBoxParameters.setTabOrder(self.groupBox_figure_size, self.doubleSpinBox_width_inches)
        GroupBoxParameters.setTabOrder(self.doubleSpinBox_width_inches, self.spinBox_width_pixels)
        GroupBoxParameters.setTabOrder(self.spinBox_width_pixels, self.doubleSpinBox_height_inches)
        GroupBoxParameters.setTabOrder(self.doubleSpinBox_height_inches, self.spinBox_height_pixels)
        GroupBoxParameters.setTabOrder(self.spinBox_height_pixels, self.spinBox_dpi)
        GroupBoxParameters.setTabOrder(self.spinBox_dpi, self.checkBox_tight_layout)
