...
class Ui_Dialog_Export(object):
    def setupUi(self, Dialog_Export):
        ...
        Dialog_Export.setTabOrder(self.comboBox_fileType, self.checkBox_transparent)
        Dialog_Export.setTabOrder(self.checkBox_transparent, self.comboBox_orientation)
        Dialog_Export.setTabOrder(self.comboBox_orientation, self.doubleSpinBox_width_inches)
        Dialog_Export.setTabOrder(self.doubleSpinBox_width_inches, self.spinBox_width_pixels)
        Dialog_Export.setTabOrder(self.spinBox_width_pixels, self.spinBox_dpi)
        Dialog_Export.setTabOrder(self.spinBox_dpi, self.doubleSpinBox_height_inches)
        Dialog_Export.setTabOrder(self.doubleSpinBox_height_inches, self.spinBox_height_pixels)
        Dialog_Export.setTabOrder(self.spinBox_height_pixels, self.checkBox_tightBbox)
        Dialog_Export.setTabOrder(self.checkBox_tightBbox, self.checkBox_open_after_export)
        Dialog_Export.setTabOrder(self.checkBox_open_after_export, self.pushButton_preview)
