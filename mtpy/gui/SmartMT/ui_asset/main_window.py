...
class Ui_SmartMT_MainWindow(object):
    def setupUi(self, SmartMT_MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/Tango/resources/icons/Tango/Text-x-generic_with_pencil.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_edi_File.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/Tango/resources/icons/Tango/Document-open.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_edi_Folder.setIcon(icon1)
