...
# Form implementation generated from reading ui file 'groupbox_rotation.ui'
#
...
class Ui_GroupBox_Rotation(object):
    ...
    def retranslateUi(self, GroupBox_Rotation):
        ...
        GroupBox_Rotation.setToolTip(_translate("GroupBox_Rotation", "<html><head/><body><p>Rotation angle (in degree)</p><p><span\n"
