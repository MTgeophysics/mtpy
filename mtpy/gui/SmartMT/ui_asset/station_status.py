...
class Ui_StationStatus(object):
    def setupUi(self, StationStatus):
        ...
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.tab_detail)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.groupBox = QtGui.QGroupBox(self.tab_detail)
    ...
    def retranslateUi(self, StationStatus):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_detail), _translate("StationStatus", "Station Detail", None))
