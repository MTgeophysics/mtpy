...
from mtpy.gui.SmartMT.Components.FigureSetting import (
    ColorBar,
    Font,
    AspectRatio,
    TextBox,
...
from mtpy.gui.SmartMT.gui.plot_control_guis import (
    PlotControlResistivityPhasePseudoSection,
)
...
class PhaseTensorMap(VisualizationBase):
    def get_plot_tooltip(self):
        ...
        return (
            "freq=%.5f, tolerance=%.2f%%, ellipse_size=%.2f, real_induction=%s, imaginary_induction=%s"
            % (
...
<p>Plot phase tensor map in Lat-Lon Coordinate System.</p>
    ...
    def __init__(self, parent):
        ...
        self._frequency_ui = FrequencySelection(
            self._parameter_ui,
            show_frequency=True,
            show_period=False,
...
class PhaseTensorPseudoSection(VisualizationBase):
    def __init__(self, parent):
        ...
        # setup gui
        self._plot_control = PlotControlResistivityPhasePseudoSection(
            self._parameter_ui
        )
    ...
    def get_plot_tooltip(self):
        ...
        return (
            "ellipse_size=%.2f, stretch=(%.2f,%.2f), linedir=%s, real_induction=%s, imaginary_induction=%s"
            % (
                ellipse["size"],
                stretch[0],
                stretch[1],
