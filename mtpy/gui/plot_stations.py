...
class PlotStations(QtWidgets.QWidget):
    ...
    def plot_new_station(self):
        self.ax.plot(
            self.station_locations.station_locations["lon"][
                self.previous_index
            ],
            self.station_locations.station_locations["lat"][
                self.previous_index
            ],
            **self.marker_dict,
        )
        ...
        self.ax.text(
            ...
            * np.sign(
            ...
            self.station_locations.station_locations["station"][
                self.previous_index
            ],
            fontdict=self.text_dict,
        )
    ...
    def on_pick(self, event):
        ...
        if event.mouseevent.button == 1:
            ...
            self.current_station = self.station_locations.station[
                self.current_index
            ]
