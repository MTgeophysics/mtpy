...
class PlotSettings(QtGui.QWidget):
    ...
    def __init__(self, parent, **kwargs):
        ...
        if isinstance(self.ns_limits, tuple):
            self.ns_limits = list(self.ns_limits)
        if isinstance(self.ew_limits, tuple):
        ...
        if isinstance(self.ellipse_range, tuple):
        ...
        if isinstance(self.res_limits, tuple):
    ...
    def initUI(self):
        ...
        ellipse_range_edit_min.textChanged[
            str].connect(self.set_ellipse_range_min)
        ...
        ellipse_range_edit_max.textChanged[
            str].connect(self.set_ellipse_range_max)
        ...
        ellipse_range_edit_step.textChanged[
            str].connect(self.set_ellipse_range_step)
        ...
        arrow_head_length_edit.textChanged[
            str].connect(self.set_arrow_head_length)
        ...
        arrow_head_width_edit.textChanged[
            str].connect(self.set_arrow_head_width)
