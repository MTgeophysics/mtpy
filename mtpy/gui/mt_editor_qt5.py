...
class PlotWidget(QtWidgets.QWidget):
    ...
    def meta_edit_loc(self):
        ...
        self.meta_loc_edit.setText('{0}'.format(self.mt_obj.station_metadata.geographic_name))
        
    def meta_edit_date(self):
        self.mt_obj.station_metadata.provenance.creation_time = str(self.meta_date_edit.text())
        self.meta_date_edit.setText(self.mt_obj.station_metadata.provenance.creation_time) 
    ...
    def fill_metadata(self):
        ...
        try:
            ...
            self.meta_elev_edit.setText('{0:.6f}'.format(self.mt_obj.elevation))
        self.meta_date_edit.setText('{0}'.format(self.mt_obj.station_metadata.provenance.creation_time))
        self.meta_loc_edit.setText('{0}'.format(self.mt_obj.station_metadata.geographic_name))
        self.meta_acq_edit.setText('{0}'.format(self.mt_obj.station_metadata.acquired_by.author))
        self.remove_distortion_num_freq_edit.setText('{0:.0f}'.format(self.mt_obj.Z.freq.size))
