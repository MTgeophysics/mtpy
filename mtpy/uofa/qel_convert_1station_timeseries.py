...
for date in dirs:
    ...
    try:
        shutil.copyfile(
            op.basename(outfn_coh), op.join(outdir_coh, op.basename(outfn_coh))
        )
    except:
        pass
    ...
    try:
        shutil.copyfile(
            op.basename(colfile), op.join(outdir_cols, op.basename(colfile))
        )
    except:
        pass
    ...
    try:
        ...
        shutil.copyfile(
            op.basename(plotfncoh), op.join(outdir_plots, op.basename(plotfncoh))
        )
