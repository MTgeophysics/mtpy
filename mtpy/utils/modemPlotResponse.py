...
def plotZ(data_dictionary):
	...
	for sta in sorted(data_dictionary):
		...
		for idx_c, comp in enumerate(components):
			...
			plot(resp_periods,resp_real,c='b')
			plot(resp_periods,resp_imag,c='r')

			#scatter(data_periods,in_data_real,c='b',marker='o')
			orig_real = errorbar(data_periods,in_data_real,yerr=in_data_error,c='b',marker='x',ls='none',)
			#scatter(data_periods,in_data_imag,c='r',marker='x')
			orig_imag = errorbar(data_periods,in_data_imag,yerr=in_data_error,c='r',marker='x',ls='none',)
