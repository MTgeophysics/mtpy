...
class Ui_occamgui2D(object):
    def setupUi(self, occamgui2D):
        ...
        self.pushButton_generateinputfile.setGeometry(QtCore.QRect(230, 630, 138, 30))
        ...
        self.pushButton_checkparameter.setGeometry(QtCore.QRect(39, 630, 129, 30))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(142, 26, 726, 262))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(60, 387, 821, 34))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(60, 569, 876, 34))
        ...
        self.doubleSpinBox_te_error.setMaximumSize(QtCore.QSize(16777215, 30))
        self.doubleSpinBox_te_error.setDecimals(0)
        self.doubleSpinBox_te_error.setMinimum(0.0)
        self.doubleSpinBox_te_error.setMaximum(100.0)
        ...
        self.doubleSpinBox_tm_error.setMaximumSize(QtCore.QSize(16777215, 30))
        self.doubleSpinBox_tm_error.setDecimals(0)
        self.doubleSpinBox_tm_error.setMinimum(0.0)
        self.doubleSpinBox_tm_error.setMaximum(100.0)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(60, 527, 856, 34))
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(143, 431, 588, 34))
        ...
        self.spinBox_maxblockwidth.setMinimum(100)
        self.spinBox_maxblockwidth.setMaximum(100000)
        self.spinBox_maxblockwidth.setProperty("value", 500)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(142, 340, 599, 34))
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(143, 298, 606, 31))
        self.layoutWidget7.setObjectName(_fromUtf8("layoutWidget7"))
        self.horizontalLayout_41 = QtGui.QHBoxLayout(self.layoutWidget7)
        ...
        self.horizontalLayout_38.addWidget(self.label_iterationstep)
        ...
        self.horizontalLayout_40.addWidget(self._label_lagrange)
        self.doubleSpinBox_lagrange = QtGui.QDoubleSpinBox(self.layoutWidget7)
        self.doubleSpinBox_lagrange.setMaximum(999.0)
        ...
        self.label_25.setBuddy(self.spinBox_layersperdecade)
