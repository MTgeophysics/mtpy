...
class GMTEllipse:
    ...
    def read_ModEM(self, datafile=None, respfile=None):
        ...
        if self.data_type == "data":
            ...
            for key in mdObj.mt_dict.keys():
                self.mt_dict[key] = mtpt.ResidualPhaseTensor(
                    pt_object1=mdObj.mt_dict[key], pt_object2=mrObj.mt_dict[key]
                )
    ...
    def write_data(self, path2savefile):
        ...
        np.savetxt(path2savefile, self.data_array, fmt=fmt)
